...
//( Giả sử cho người dùng nhập doanh số bán hàng, 
// phần trăm hoa hồng theo từng mốc doanh thu cần đạt tương ứng. )

// let a =Number(prompt(`Doanh so ban hang`));
// let b1 = Number(prompt(`phan tram hoa hong 1`));
// let b2 = Number(prompt(`phan tram hoa hong 2`));
// let b3 = Number(prompt(`phan tram hoa hong 3`));
